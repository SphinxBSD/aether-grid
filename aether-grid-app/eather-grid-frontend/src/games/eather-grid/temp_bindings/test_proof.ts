...
async function main() {
    const circuitPath = path.resolve('../../zkbytecode/map_1.json');
    ...
    try {
        ...
        console.log("Proof length:", generatedProof.proof.length);
        console.log("Public inputs:", generatedProof.publicInputs);
    } catch (e) {
        console.log("ERROR", e);
    }
}
