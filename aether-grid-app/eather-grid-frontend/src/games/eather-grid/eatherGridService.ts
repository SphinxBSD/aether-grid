import { Client as EatherGridClient, type Game } from './bindings';
...
/**
 * Service for interacting with the EatherGrid game contract
 */
...
// Example: const eatherGridService = new EatherGridService(contractId);
