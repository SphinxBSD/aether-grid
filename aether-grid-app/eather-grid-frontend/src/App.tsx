...
import { EatherGridGame } from './games/eather-grid/EatherGridGame';

const GAME_ID = 'eather-grid';
const GAME_TITLE = import.meta.env.VITE_GAME_TITLE || 'Eather Grid';
      ...
      {!hasContract ? (
        <div className="card">
          ...
          <p style={{ color: 'var(--color-ink-muted)', marginTop: '1rem' }}>
            ...
            <code>VITE_EATHER_GRID_CONTRACT_ID</code> in the root <code>.env</code>.
          </p>
        </div>
      ) : !devReady ? (
        <div className="card">
