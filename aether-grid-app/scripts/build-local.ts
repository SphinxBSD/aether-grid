...
/**
 * Build script for Soroban contracts (Local)
 *
...
function usage() {
  console.log(`
Usage: bun run build:local [contract-name...]

Examples:
  bun run build:local
  bun run build:local number-guess
  bun run build:local twenty-one number-guess
`);
}

console.log("🔨 Building Soroban contracts for local...\n");
...
console.log("🎉 Local Contracts built successfully!");
console.log("\nWASM files:");
for (const contract of contractsToBuild) {
